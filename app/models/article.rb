...
has_attached_file :thumbnail_img, styles: { medium: "300x300>", thumb: "100x100>" }
...
validates_attachment :thumbnail_img, content_type: { content_type: ["image/jpg", "image/jpeg", "image/png", "image/gif"] }
...
validates_attachment :interview_img, content_type: { content_type: ["image/jpg", "image/jpeg", "image/png", "image/gif"] }
end
